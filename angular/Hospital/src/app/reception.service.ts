...
const receptionUrl = 'http://127.0.0.1:80/api/api/receptions/';
...
export class ReceptionService {
  ...
  */
  ...
  getDoctors(): Observable<Doctor[]>{
    ...
    return this.http.get<Reception[]>('http://127.0.0.1:80/api/api/doctors/', this.httpOptions)
      .pipe(
        tap(_ => this.log('fetched reception')),
  ...
  getTime() : Observable<Time[]>{
    ...
    return this.http.get<Time[]>('http://127.0.0.1:80/api/api/time/', this.httpOptions )
    .pipe(
      tap(_ => this.log('fetched reception')),
      catchError(this.handleError<Reception[]>('getDoctors ', []))
    );
  ...
  */
  ...
  createReception(data: Reception): Observable<Reception> {
    ...
    return this.http.post('http://127.0.0.1:80/api/api/receptions/', data, this.httpOptions).pipe(
      tap(_ => this.log('fetched reception')),
